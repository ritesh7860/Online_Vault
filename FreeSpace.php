 ...
 return result;
     ...
     <style>
                 body{
                      ...
                      div form input[type=text]:focus,div form input[type=email]:focus
                      {
...
<body>
    ...
    <div class="form">
        <form align="center" method="post" name="frm" onsubmit="return f()"><br>
                Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type= "text" name="fnm"  placeholder ="Full Name" /><b id="nm1" ></b><hr></hr>
                Email: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type= "email"  name="mail"  placeholder ="Enter mail" /><b id="mL"></b><hr></hr>
                Password:<input type ="password" name="pwd1"  placeholder ="Password" ><b id="pw"></b><hr></hr>
